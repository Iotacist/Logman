...
public class ConcurrentSocketServer implements Runnable {
	...
	/**
	 * Constructs a new <code>AsyncSocketServer</code> instance with the specified address,
	...
	public void run() {
        ...
        while(isRunning()) {
            ...
            try {
                ...
                log.info("Client connected from " + clientSocket.toString());
            } catch (IOException e) {
            ...
            serverThreadPool.execute(new ConcurrentSocketHandler(clientSocket));
        }
